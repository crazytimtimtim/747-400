...
**Will there be an EFB? Is there Avitab integration?**
...
Additionally, the brake lever and X-Plane brakes are now seperated, there is a new command to engage the brakes by lifting the parking brake lever.
